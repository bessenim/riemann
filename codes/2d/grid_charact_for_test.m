...
for p2 = 1:(sp_g_i(g,2))
    u0_p1_p2_n(sp_g_i(g,1),p2,1) = -4;
    u0_p1_p2_n(sp_g_i(g,1),p2,2) = -2.5;
    u0_p1_p2_n(sp_g_i(g,1),p2,3) = 1.5;
    u0_p1_p2_n(sp_g_i(g,1),p2,4) = 0;
    u0_p1_p2_n(sp_g_i(g,1),p2,5) = -0.5;
end
...
%         end
        ...
        for p1 = sp_g_i(g,1)
            for p2 = 2:(sp_g_i(g,2)-1)
                ...
                unext_g_p1_p2_n{gmin}(p1,p2,:) = W(1:sn,1); 
                unext_g_p1_p2_n{gpls}(1,p2,:) = W(sn+1:sn+sn,1);
            end
        end
%         for p1 = sp_g_i(g,1)
%             for p2 = sp_g_i(g,2)
...
x_p1 = cat(2,x_p{1,1},x_p{2,1});   
x_p2 = x_p{1,2};
K_p1_p2_jt = cat(1,K_g_p1_p2_jt{1},K_g_p1_p2_jt{2})*0.1;
